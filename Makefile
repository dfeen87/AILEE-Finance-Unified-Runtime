...
demo: $(EXAMPLE_SRC) aille.hpp extensions/aille_btc.cpp
	$(CXX) $(CXXFLAGS) $(INCLUDES) $(OPTFLAGS) $(EXAMPLE_SRC) extensions/aille_btc.cpp -o demo
	@echo ""
...
# Debug build
debug: $(EXAMPLE_SRC) aille.hpp extensions/aille_btc.cpp
	$(CXX) $(CXXFLAGS) $(INCLUDES) $(DEBUGFLAGS) $(EXAMPLE_SRC) extensions/aille_btc.cpp -o demo_debug
	@echo ""
...
# Hotpath build
hotpath: $(EXAMPLE_SRC) aille.hpp extensions/aille_btc.cpp
	$(CXX) -std=c++17 -Wall -Wextra $(INCLUDES) -fno-exceptions -DAILLE_HOTPATH -O3 -march=native $(EXAMPLE_SRC) extensions/aille_btc.cpp -o demo_hotpath
	@echo ""
	@echo "✓ Hotpath build ready"
	@echo ""

# Build and run unit tests
test_suite: $(UNIT_TESTS_SRC) aille.hpp extensions/aille_btc.cpp
	$(CXX) $(CXXFLAGS) $(INCLUDES) $(OPTFLAGS) $(UNIT_TESTS_SRC) extensions/aille_btc.cpp -o test_suite
	@echo ""
...
# Benchmark
benchmark: $(BENCHMARK_SRC) aille.hpp extensions/aille_btc.cpp
	$(CXX) $(CXXFLAGS) $(INCLUDES) $(OPTFLAGS) $(BENCHMARK_SRC) extensions/aille_btc.cpp -o benchmark
	@echo ""

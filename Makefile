...
release:
	...
	@echo "11.0.0" > release/VERSION
	@printf "$(COLOR_GREEN)✓ Stamped Version: 11.0.0$(COLOR_RESET)\n"
	@printf "$(COLOR_GREEN)AILEE CORE v11.0.0 Release Package Ready.$(COLOR_RESET)\n"
...
install: aille.hpp
	@echo "Installing AILLE v11.0.0 Framework..."
	@echo "Copying headers to system path..."
	sudo cp aille.hpp /usr/local/include/
	@echo "✓ Header installed (Version 11.0.0)"

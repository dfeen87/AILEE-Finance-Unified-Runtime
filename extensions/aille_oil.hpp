...
#ifndef AILLE_OIL_HPP
#define AILLE_OIL_HPP
...
struct alignas(64) OILState {
    ...
    constexpr OILState() : price(0.0f), realized_vol(0.0f), drawdown(0.0f), trend_score(0.0f), smoothed_vol(0.0f), _reserved_padding{} {}
};
static_assert(sizeof(OILState) == 64, "OILState must be exactly 64 bytes");

struct alignas(64) OILAdvisory {
    ...
    constexpr OILAdvisory() : recommended_weight(1.0f), risk_score(0.0f), risk_elevated(false), growth_favorable(true), _reserved_padding{} {}
};
static_assert(sizeof(OILAdvisory) == 64, "OILAdvisory must be exactly 64 bytes");

struct alignas(64) OILObservabilityMetrics {
    float risk_score;
    ...
    constexpr OILObservabilityMetrics() : risk_score(0.0f), volatility_band(0.0f), advisory_weight(0.0f), trend_score(0.0f), _reserved_padding{} {}
};
static_assert(sizeof(OILObservabilityMetrics) == 64, "OILObservabilityMetrics must be exactly 64 bytes");

[[nodiscard]] constexpr OILAdvisory evaluate_oil_state(
    const OILState& state,

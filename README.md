...
- [v10.1.0: Deterministic Governance Stack (Layers 8–15)](#v1010--deterministic-governance-stack-layers-815)
...
2. Stamps the deployment version in `release/VERSION` (containing `10.1.0`).

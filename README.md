...
- **Simulation harness:** Run `python3 simulations/aille_simulation.py` for a reproducible synthetic comparison of AILLE vs a naive baseline, or provide CSVs for real market returns/signals. See `docs/simulation.md` for details.
